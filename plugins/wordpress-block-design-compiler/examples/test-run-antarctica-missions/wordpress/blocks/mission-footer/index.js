(function (blocks, blockEditor, element) {
  ...
  registerBlockType('wbdc/mission-footer', {
    edit: function Edit(props) {
      const attributes = props.attributes;
      return el('footer', useBlockProps({ className: 'mission-footer' }),
    ...
    save: function Save(props) {
      const attributes = props.attributes;
      return el('footer', useBlockProps.save({ className: 'mission-footer' }),
